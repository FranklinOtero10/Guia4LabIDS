...
<div class="container-fluid">
    ...
    <div class="ml-md-4 mr-md-4">
        <div class="row">
            <div class="offset-md-2 col-md-4 col-sm-12">
                <form action="<?= site_url("estudiantes"); ?>/<?= isset($estudiante) ? "update" : 'add'; ?>" method="POST">
                    ...
                    <div class="form">
                        ...
                        <br>
                        <div class="form-group">
                            <input class="btn btn-success" type="submit" value="Guardar"> <a class='btn btn-primary' href="<?= site_url('estudiantes') ?>">Volver</a>
                        </div>
                    </div>
